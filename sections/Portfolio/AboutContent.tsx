...
export default function AboutContent({
  ...
  return (
    <div class="mx-auto px-5 mt-16 md:mt-20 md:w-[600px] lg:container lg:px-[212px] lg:flex lg:px-24 lg:mt-[138px] 2xl:mt-[120px] 2xl:mb-[40px]">
      <div class="flex-none flex justify-center mb-16 lg:block lg:w-[425px]">
      ...
      <div class="flex-auto">
        ...
        <h1
          id="aboutTitle"
          class={`${classes} text-3xl leading-[1.18] font-medium mb-4 md:mb-7 md:text-5xl delay-100`}
        >
          {title}
        </h1>
        ...
        <div id="aboutButton" class={`${classes} pt-2 delay-[500ms]`}>
          <a
            href={button.href}
            target="_blank"
            class="inline-block bg-black text-white px-[25px] py-[13px] font-medium border-[3px] border-black hover:text-black hover:bg-transparent duration-200"
          >
            {button.label}
          </a>
        </div>
        <div class="flex flex-col text-xl mt-20 gap-12 md:gap-0 md:mt-28 md:flex-row">
