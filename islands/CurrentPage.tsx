...
import Marquee from "$store/islands/Marquee.tsx";
...
export default function CurrentPage({
  ...
  return (
    <div class="border-y border-[#D9D9D9] mt-10 py-[94px] md:mt-[100px] md:py-[112px] lg:mt-[90px]">
      <div
        id="navText"
      ...
      >
        <a
          href={next}
          class="inline-block bg-black text-white px-[25px] py-[13px] font-medium border-[3px] border-black md:hover:text-black md:hover:bg-transparent duration-200"
        >
          Next Project
        </a>
      </div>
